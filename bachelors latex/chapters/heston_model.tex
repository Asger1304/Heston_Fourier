...
In the paper they show that the CF extends to $[-1,0]$ via an equivalent expression of the moment generating function and thus the CF, then using an analytical continuation argument.
