...
\end{theorem}
\subsubsection{The Feynman-Kac Formula}
...
notes:
\begin{itemize}
\item[$\bullet$] f has polynomial growth $\Leftrightarrow \exists c>0,p\geq 0:|f(x)|\leq c(1+\vert x \vert^p)\forall x\in\mathbb{R}$
...
\begin{figure}[H]
  ...
  \caption{Calibration speed experiment: wait time and $\sum|\Delta\sigma|$ relative to the GK baseline across 20 random Heston parameter draws satisfying the Feller condition.}
